 ...
 * generated in the com.van.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Operacion_QNAME = new QName("http://ws.van.com/", "operacion");
    private final static QName _OperacionResponse_QNAME = new QName("http://ws.van.com/", "operacionResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.van.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.van.com/", name = "operacion")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.van.com/", name = "operacionResponse")
